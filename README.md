...
This repository is part of a two-module research system.
🔗 For complete fundamental analysis, visit the second repo:
👉 https://github.com/Naja24/Stock-Market-Fundamental-Analysis

🚀 Overview

This project focuses on Technical Analysis and Machine Learning-based Stock Price Forecasting.
It includes:
...
🧱 Architecture
Input → Preprocessing → Windowing → Model (LSTM/N-BEATS/TFT)
